...
public final class Constants {
    ...
    // Motors and Pneumatics not related to the SwerveDrive
// Intake
    public static final int INTAKEPNEUMATIC_FORWARD = 0;
    public static final int INTAKEPNEUMATIC_REVERSE = 1;
